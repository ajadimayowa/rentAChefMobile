...
const UserCompletedBookingTab: React.FC<any> = () => {
    ...
    const fetchBookings = async () => {
        ...
        setLoading(true)
        try {
            const res = await api.get(`/bookings?clientId=${localProfile.id}&status=completed`)
...
export default UserCompletedBookingTab